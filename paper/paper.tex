...
\begin{enumerate}
 ...
 \item Build stacking feature by predicting $testing$ and $training_1$ using original features from $N-1$ folds ($training_2$, $training_3$, $...$, $training_N$) with first stage model
...
\begin{figure}[ht!]
\centering
\includegraphics[width=95mm]{Rplot.png}
