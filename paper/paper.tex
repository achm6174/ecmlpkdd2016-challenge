...
\begin{enumerate}
 \item The training data is a combination data in two periods. If folds are split by time,
  stacking feature is built based on information from different time period, which is useful to avoid overfitting.

 \item Both stacking provides improvement on local CV, but 10 folds show discrepancy between CV and 30\% of testing data.
\end{enumerate}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=115mm]{Rplot.png}
